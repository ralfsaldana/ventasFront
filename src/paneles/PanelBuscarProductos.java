 ...
 * @author rsaldana
 */
public class PanelBuscarProductos extends PanelGenerico implements ListSelectionListener, KeyListener, MouseListener{

    private BuscarProductosModal padre;
    private DefaultTableModel model;
    private Producto productoSeleccionado;
    
    /**
     * Creates new form PanelBuscarProductos
     */
    public PanelBuscarProductos(BuscarProductosModal padre) {
        this.padre = padre;
        initComponents();
        configurarTabla();
        ...
        PlaceHolder placeholder = new PlaceHolder("Escriba un nombre de producto", txtDescripcion);
    ...
    private void listarProductos(ArrayList<Producto> items) {           
            ...
            for(Producto e : items) {
                ...
                model.setValueAt(e.getCantidadProducto(), fila, 3);                                                             
                fila ++;
            }
    }
    ...
    public void valueChanged(ListSelectionEvent e) {
        try {
            if(tabla.getSelectedRowCount()>0){
                Long idProductoSeleccionado = (Long) tabla.getValueAt(tabla.getSelectedRow(), 0);
                this.productoSeleccionado = new ProductoService().obtenerProductoPorId(idProductoSeleccionado);                
            }        
        } catch (Exception ex) {
    ...
    public void keyPressed(KeyEvent e) {
        try {
            ...
            if(txtDescripcion.getText().isEmpty()){
                ...
                listarProductos(service.filtrarProductos(txtDescripcion.getText()));
                }
        } catch (Exception xe) {
            xe.printStackTrace();
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getClickCount()==2){
            padre.setProductoSeleccionado(this.productoSeleccionado);
            padre.dispose();                 
       }
    }
